...
\text{Si} $n=k=0$: $u_{1}=\frac{14}{3}\geq \sqrt{3}$\\
\text{Si} $n=k=1$: $u_{2}=\frac{26}{7}\geq \sqrt{3}$\\
\textbf{Supposons que la propiété est vrai au rang $n$.Vérifions au rang $k+1$} \\
$n=k+1$
\begin{align*}
u_{k+1+1}&=\frac{1}{u_{k+1}}+\frac{3}{4}u_{k+1}\\
&=\frac{1}{\frac{1}{u_{k}}+\frac{3}{4}u_{k}}+\frac{3}{4}\left(\frac{1}{u_{k}}+\frac{3}{4}u_{k}\right):
\begin{cases}
\frac{1}{\frac{1}{u_{k}}+\frac{3}{4}u_{k}}\\
\frac{3}{4}\left(\frac{1}{u_{k}}+\frac{3}{4}u_{k}\right)\\
\end{cases}
\end{align*}
