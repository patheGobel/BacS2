...
%\( G \) barycentre du système \( \{(A,1), (B,1), (O,2)\} \) donc
%\( \overrightarrow{AG}=\frac{1}{4}\overrightarrow{AB}+\frac{1}{2}\overrightarrow{AO}  \)
\end{itemize}

%5) Déterminer puis construire l'ensemble \( P \) des points \( M \) du plan tels que 
%$
%||\overrightarrow{CA} + \overrightarrow{CB} + 2\overrightarrow{CO}|| \leq 2.
%$
