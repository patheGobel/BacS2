...
$\mid\frac{z_C - z_B}{z_A - z_B}\mid=1 \implies \frac{BC}{BA}\mid=1\implies BC=BA$
\begin{align*}
...
Comme BADC est un carré et que A, B, C et D sont sur un même cerlce donc [BD] est un diamètre ce cercle. 

Un rayon est de ce cercle $r=IB=\frac{BD}{2}$ où I est le centre de ce cerlce
...
BD&=|z_{D}-z_{B}|\\
	...
	&=\sqrt{26}
\end{align*}
\[\text{donc }r=IB=\frac{BD}{2}=\frac{\sqrt{26}}{2}\textbf{ 0,25 pt}\]
\end{itemize}
\[Z_{I}=\frac{Z_{D}+Z_{B}}{2}=\frac{3-i+(-2)}{2}=\frac{1-i}{2}=\frac{1}{2}-\frac{1}{2}i \textbf{ 0,25 pt}\]
\[Z_{I}=\frac{1}{2}-\frac{1}{2}i\]
