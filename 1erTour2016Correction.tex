...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item On pose $Z=\frac{z-3}{z-5+2i}.$
		
		Donnons une interprétation géométrique de l’argument de Z.\textbf{ 0,5pt}
		
		$Z=\frac{z-3}{z-5+2i}=\frac{z-(2)}{z-(5-2i)}=\frac{z_{M}-z_{A}}{z_{M}-z_{B}}$
...
\item
\begin{enumerate}
\item[a.] Déterminons les fonctions $u$ et $v$ telles que pour tout $x \in ]0, +\infty[$ ,\\ $m(x) = u'(x)v(x)+u(x)v'(x)$. $\textbf{0,25 pt}$

Dérivons $\left( \frac{\ln(x+1)}{x} \right) $ pour voir si on va trouver $m(x)$:

$-\left( \ln(x+1) \times \frac{1}{x} \right)'=-\left(\frac{1}{x+1}\times \frac{1}{x}+\ln(x+1) \times \frac{-1}{x^{2}} \right)=\frac{\ln(x+1)}{x^{2}}-\frac{1}{(x+1)x}$

\[
\textcolor{green}{ \boxed{ -\left(\ln(x+1) \times \frac{1}{x} \right)'=\frac{\ln(x+1)}{x^{2}}-\frac{1}{(x+1)x}} } \]

\textcolor{green}{Donc $u(x)=-\ln(x+1)$ et $v(x)=\frac{1}{x}$}

\item[b.] Déduisons-en la fonction $H$ définie sur $]0, +\infty[$ telle que $H'(x) = m(x)$

$H'(x)=-\ln(x+1) \times \frac{1}{x}$

Calculons  \[ \int_{1}^{2}\frac{1}{f(x)}dx \textbf{ 0,75 pt}\]

\[\text{sur } [1;2], f(x)=\frac{x^{2}}{\ln(x+1)} \text{donc } \frac{1}{f(x)}=\frac{\ln(x+1)}{x^{2}}=\ln(x+1)\times \frac{1}{x^{2}}\]

Intégration par partie:

posons $u(x)= $ et $v(x)= $
\[ \int_{1}^{2}\frac{1}{f(x)}dx=\int_{1}^{2}\frac{\ln(x+1)}{x^{2}}dx \text{ or } -\left(\ln(x+1) \times \frac{1}{x} \right)'=\frac{\ln(x+1)}{x^{2}}-\frac{1}{(x+1)x}\]

\begin{align*}
\text{Donc } \int_{1}^{2}\frac{\ln(x+1)}{x^{2}}dx &=\frac{\ln(x+1)}{x^{2}}\\
&=\int_{1}^{2}\left(-\ln(x+1) \times \frac{1}{x} \right)'dx+\int_{1}^{2}\frac{1}{(x+1)x}dx\\
&=-\ln(x+1) \times \frac{1}{x}+\ln\left[ (x+1)x\right] 
\end{align*}
\[
\textcolor{green}{ \boxed{ \int_{1}^{2}\frac{1}{f(x)}dx=\left[-\ln(x+1) \times \frac{1}{x}+\ln\left[ (x+1)x\right] \right]_{1}^{2}  } }
\]

\begin{align*}
\int_{1}^{2}\frac{1}{f(x)}dx &=\left[-\ln(2+1) \times \frac{1}{2}+\ln\left[ (2+1)2\right] \right]-\left[-\ln(1+1) \times \frac{1}{1}+\ln\left[ (1+1)1\right] \right]\\
&=\left[-\ln(3) \times \frac{1}{2}+2\ln\left[ 6\right] \right]-\left[-\ln(2)+\ln\left[ (2)\right] \right]\\
&=\left[-\ln(3) \times \frac{1}{2}+2\ln\left[ 6\right] \right]\\
&=\left[ \frac{-\ln(3)+4\ln\left[ 6\right]}{2}\right]\\
&=\left[ \frac{3\ln(3)+4\ln\left[ 2\right]}{2}\right]
\end{align*}
\[
\textcolor{green}{ \boxed{ \int_{1}^{2}\frac{1}{f(x)}dx= \left[ \frac{3\ln(3)+4\ln\left[ 2\right]}{2}\right] } }
\]
\end{enumerate}
\end{enumerate}
\end{document}
