...
$\left(\ln(x+1) \times \frac{1}{x} \right)'=\frac{1}{x+1}\times \frac{1}{x}+\ln(x+1) \times \frac{-1}{x^{2}}=\frac{\ln(x+1)}{x^{2}}-\frac{1}{(x+1)x}$
...
%puis calculer  $\int_{1}^{2}\frac{1}{f(x)}dx$.$\textbf{ 0,75 pt}$
\end{enumerate}
\end{enumerate}
\end{document}
